    ...
    return ValueListenableBuilder(
      ...
      child: Scaffold(
       floatingActionButtonLocation: FloatingActionButtonLocation.endFloat,
        floatingActionButton: FloatingActionButton(child: Icon(FontAwesomeIcons.plus),
                 ...
                 // mainAxisAlignment: MainAxisAlignment.center,
                  ...
                  children: [
                    Padding(
                      ...
                      child: Image.asset('assets/icon.png',scale: 2.7,),
                    ),
                    Column(
                      mainAxisAlignment: MainAxisAlignment.center,
                      ...
                      children: [
                        Text('Good Morning'),
                        Text('Whats Going on Today ? ',style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20),),
